...
public interface MyPageDAO {
	...
	ArrayList<MyPageDTO> requestBoardList(int user_no, int i, int offset);

	MyPageDTO recipeBoardList(int user_no);
	...
	MyPageDTO recipeComments(int user_no);

	MyPageDTO recipeFavorite(int user_no);
