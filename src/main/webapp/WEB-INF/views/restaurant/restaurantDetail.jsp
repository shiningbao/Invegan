...
<body>
	...
	<div id="container">
		<div class="restaurantTop">
			<h1>식당 상세보기</h1>
			${restaurantDetail} ${menuDetail} ${photoList}
			<div class="restaurantImg_main">
				<img id="img_main" src="/photo/${photoList[0]}" alt="restaurantImg" />
			</div>
			<div class="restaurantContent">
				비건 단계 ${restaurantDetail.getTitle()} 즐겨찾기 별점
		...
		<div class="restaurantMap">
			<h2>식당 위치</h2>
			<p>${restaurantDetail.getAddress()}</p>
			<div id="map"></div>
		</div>
		...
		<div class="reviewDiv">
			...
			<input name="wirteReview" type="text" /> <select name="rating">
...
<script>
	...
	$('#update').on('click', function() {
		...
		if (confirm('수정하시겠습니까?')) {
			location.href = 'update.go?post_id=' + $
			{
				restaurantDetail.getPost_id()
			}
			;
		} else {
