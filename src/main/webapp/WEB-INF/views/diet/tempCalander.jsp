...
<body>
	<h2>식단관리 페이지</h2>
	<!-- 도훈이 테스트 영역 -->
		<input id="loginId" name=loginId type="text" placeholder="임시 로그인 영역" value="admon01"/>
...
<script>
	...
	function chkData(chk) {
		...
		window.open("addMenu.go?chk="+chk+"&loginId="+loginId, "pop", "width=1000,height=800,scrollbars=yes")
